...
\end{equation}
Estes erros estão associados a montagem do experimento, pois é
possivel que o alinhamento dos espelhos não estejam perfeitamente
alinhados, alem do feixe podendo não estar colidindo exatamente no
centro do espelho fixo, e isto tambem pode causa um acrescimo no
erro. Porem dentre todos os fatores associados o erro associado de
2,3\% está aceitavel dentro da precisão nescessaria para a realização
do experimento.
